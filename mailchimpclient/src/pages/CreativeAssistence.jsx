...
import "../styles/CreativeAssistance.css";
import { Link } from "react-router-dom";

const CreativeAssistence = () => {
  return (
    <div
        ...
        <div class="redesignNavigationExpandedRRClosed-1Pz4X snipcss0-2-5-6">
          ...
          <main id="content" class="body-1uBId snipcss0-3-6-246">
            <div class="frame-1q4n0 snipcss0-4-246-247">
              <div class="container-zoT84 snipcss-a3gPF">
                <div class="main-38WlA">
                  <div class="teaserVideoWrapper-OsrrI">
                    <div class="teaserPosterWrapper-TPGxY">
                      <img
                        src="https://cdn-images.mailchimp.com/automations/creative-assistant/creative-assistant-teaser-explainer-poster.gif"
                        alt="an example set of designs produced by auto designer."
                        class="teaserPosterImage-5x2rQ"
                      />
                      <button type="button" class="teaserPlayButton-1S30u">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 24 24"
                          focusable="false"
                    ...
                    <video
                      controls=""
                      width="100%"
                      src="https://cdn-images.mailchimp.com/automations/creative-assistant/creative-assistant-teaser-explainer-video.mp4"
                      class="teaserVideo-2ZV-F"
                    ></video>
                  </div>
                </div>
                <div class="contentContainer-2EhCe">
                  <div class="header-5encs">
                    <h1 class="heading-4-3r-mu headerTitle-1ZqKQ root-PihPG">
                      Creative Assistant
                    </h1>
                  </div>
                  <div class="content-UjddH">
                    <div class="stack-1qp4V spacing4-1xt6w">
                      <span>
                        <span class="wink">
                          <button
                            class="container-3Ddep tierTwo-2NDDD clickable-UqZZf"
                            type="button"
                          >
                            <span class="circle-22psN animate-2Lc7H"></span>
                            <span
                              class="image-eHLbF tierTwo-2NDDD intro-vKtnE animate-2Lc7H style-TikWo"
                              id="style-TikWo"
                            ></span>
                            <img
                              class="image-eHLbF tierTwo-2NDDD hidden-3qIq_"
                              src="https://digitalasset.intuit.com/render/content/dam/intuit/mc-fe/en_us/images/components/smartmark/tier2hover_optimized.gif"
                              alt=""
                            />
                            <span class="label-3lkw0 animate-2Lc7H">
                              <span class="text-1AWaQ animate-2Lc7H">
                                Based on your brand
                              </span>
                            </span>
                            <span class="circle-22psN animate-2Lc7H"></span>
                      ...
                      <h1 class="heading-1-2zF42 root-PihPG">
                        Custom designs <br /> in just a few clicks.
                      </h1>
                      <p class="root-3TDqk medium-3AcAC subtitle-1_e-L">
                        Give us a few minutes, and we'll give you back hours.
                        Let us create beautiful, on-brand designs across
                        multiple channels for you. Enter your website URL to get
                        started.
                      </p>
                      <form
                      ...
                      >
                        <div class="cluster-3D5Qr">
                          <div class="alignItemsCenter-1HCiJ justifyFlexStart-ejJl1 spacing4-1S_zR">
                            <div class="root-2RFjU urlInput-2Yn_S">
                            ...
                            <button
                              class="root-sBgFt container-3-bH7 primary-33czz button-3mfLr inlineSubmit-2lQnG"
                              label="Import My Brand"
                              type="submit"
                            >
                        ...
                        <p class="root-3TDqk small-secondary-3_Rq2">
                          ...
                          warrant that you own or have permission to use all of
                          the content from this website.
                        </p>
                      </form>
                      <div class="container-2gdFc">
                        <div class="stack-1qp4V spacing2-3AKCb container-3WgXQ">
                          <h2 class="heading-4-3r-mu root-PihPG">Explore</h2>
                          <div>
                            <p class="root-3TDqk small-2qKd5">
                              See Creative Assistant at <br /> work with a
                              sample brand
                            </p>
                          </div>
                          <button
                            class="root-sBgFt container-3-bH7 secondary-1_P2K cta-_4idz"
                            type="button"
                          >
                            <span class="temporarySpan-2iF2p">
                              Try Sample Brand
                        ...
                        <div class="stack-1qp4V spacing2-3AKCb container-23M3J">
                          <h2 class="heading-4-3r-mu root-PihPG">
                            Upload Logo
                          </h2>
                          <p class="root-3TDqk small-2qKd5">
                            Upload your brand
                          ...
                          <button
                            class="root-sBgFt container-3-bH7 secondary-1_P2K cta-2nBpH"
                            type="button"
                          >
                            <span class="temporarySpan-2iF2p">
                              Upload My Logo
...
export default CreativeAssistence;
