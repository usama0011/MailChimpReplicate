...
import "../styles/AutomationOver.css";
        ...
        <div class="redesignNavigationExpandedRRClosed-1Pz4X snipcss0-2-5-6">
          ...
          <main id="content" class="body-1uBId snipcss0-3-6-246">
            <div class="frame-1q4n0 snipcss0-4-246-247">
              ...
              <div>
                <div className="root-3uY95 snipcss-iRxbY">
                    ...
                    <header className="root-1rj4d standard-2H4cn header-3IL6q">
                      <div className="cluster-3D5Qr nowrap-34OZ-">
                        <div className="alignItemsCenter-1HCiJ justifyFlexStart-ejJl1 spacing4-1S_zR">
                          <div
                            className="stack-1qp4V style-MqomM"
                            id="style-MqomM"
                          >
                      ...
                      <div className="actions-1bN9W cluster-3D5Qr">
                        <div className="alignItemsCenter-1HCiJ justifyFlexStart-ejJl1 spacing4-1S_zR">
                          <a
                            ...
                            href="/customer-journey/create-new-journey/"
                          >
                          ...
                          <a
                            className="root-sBgFt container-3-bH7 primary-33czz"
                            href="/customer-journey/explore/"
                          >
                            <span className="temporarySpan-2iF2p">
                              Choose pre-built journey
                            </span>
                          </a>
                        </div>
                      </div>
                  ...
                  <div className="root-19H_5 withSecondary-3qa5O cornflower-2jfB_">
                    <div className="root-1rj4d standard-2H4cn">
                      <div className="switcher-2RqDX">
                        <div className="spacing8-B_6pF">
                          <div
                            className="stack-1qp4V spacing6-nznRY style-BifGA"
                            id="style-BifGA"
                          >
                            <h2 className="heading-1-2zF42 root-PihPG">
                              Welcome customers to your store
                            </h2>
                            <p className="root-3TDqk medium-3AcAC">
                              Introduce customers to your brand with an
                              automated welcome email that lets you share your
                              story, highlight products, or send special offers.
                            </p>
                          ...
                          <div
                            className="secondaryContent-kYYJm style-ZvQXf"
                            id="style-ZvQXf"
                          >
                            <img
                              alt="[object Object]"
                              src="https://cdn-images.mailchimp.com/product/automation/pre-built-journeys/logo-cloud@2x.png"
                            />
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="root-1rj4d standard-2H4cn withBottomGutter-1OHF7 withTopGutter-PMsAu">
                    <div className="stack-1qp4V spacing9-XZMyI">
                      <div>
                        <div className="header-S-Iib">
                          <h2 className="heading-3-eDQNF root-PihPG">
                            Popular pre-built journeys
                          </h2>
                        </div>
                        <div
                          className="root-209cT gap6-U7x7I style-BFvEg"
                          id="style-BFvEg"
                        >
                          <div className="clickArea-2gAoC card-23rCG">
                            <div className="stack-1qp4V spacing4-1xt6w">
                              <div className="cluster-3D5Qr">
                                <div className="alignItemsFlexStart-3pYa_ justifySpaceBetween-2M_OY spacing4-1S_zR">
                                  <div className="coinContainer-2xKr9">
                                    <div
                                      className="coin0-31PKX"
                                      aria-describedby="mc:44"
                                    >
                                      <img
                                        src="https://digitalasset.intuit.com/content/dam/intuit/mc-fe/en_us/images/sms/email-coin.svg"
                                        alt="E-mail logo"
                                        height="16"
                                        width="16"
                                      />
                                  ...
                                  <div className="cluster-3D5Qr">
                                    <div className="alignItemsCenter-1HCiJ justifyFlexStart-ejJl1 spacing2-3-fWQ">
                                      <span className="root-3ALOt success-3BGCN">
                              ...
                              <div className="minTitleHeight-RZR--">
                                <button
                                  className="root-sBgFt root-22EAH targetLink-IwIqd"
                                  type="button"
                                >
                              ...
                              <div className="cluster-3D5Qr">
                                <div className="alignItemsFlexStart-3pYa_ justifySpaceBetween-2M_OY spacing4-1S_zR">
                                  <div className="coinContainer-2xKr9">
                                    ...
                                    <div
                                      className="coin1-2ksi2"
                                      aria-describedby="mc:48"
                                    >
                                      <img
                                        src="https://cdn-images.mailchimp.com/product/automation/apps-integrations-logomarks/shopify.svg"
                                        alt="Shopify logo"
                                        height="16"
                                        width="16"
                                      />
                                    ...
                                    <div
                                      className="coin2-3oefo"
                                      aria-describedby="mc:49"
                                    >
                                      <img
                                        src="https://cdn-images.mailchimp.com/product/automation/apps-integrations-logomarks/woocommerce.svg"
                                    ...
                                    <div
                                      className="coin-P_pwD"
                                      aria-describedby="mc:50"
                                    >
                                      <p className="root-3TDqk small-2qKd5 overflowText-3qImX">
                                        +18
                                      </p>
                                    </div>
                                  </div>
                              ...
                              <div className="cluster-3D5Qr">
                                <div className="alignItemsFlexStart-3pYa_ justifySpaceBetween-2M_OY spacing4-1S_zR">
                                  <div className="coinContainer-2xKr9">
                                    ...
                                    >
                                      <img
                                        src="https://cdn-images.mailchimp.com/product/automation/apps-integrations-logomarks/facebook.svg"
                                        alt="Facebook logo"
                                        height="16"
                                        width="16"
                                      />
                                    ...
                                    >
                                      <img
                                        src="https://cdn-images.mailchimp.com/product/automation/customerJourneys/zapier-icon.svg"
                                        alt="Zapier logo"
                                        height="16"
                                        width="16"
                                      />
                                  ...
                                  <div className="cluster-3D5Qr">
                                    <div className="alignItemsCenter-1HCiJ justifyFlexStart-ejJl1 spacing2-3-fWQ"></div>
                                  </div>
                                </div>
                              </div>
                              <div className="minTitleHeight-RZR--">
                          ...
                          <div className="clickArea-2gAoC card-3pI7n">
                            <div className="linkCardCenter-1hbuc">
                              <a
                                className="targetLink-263pj textCenter-3gRxF"
                                href="/customer-journey/explore"
                              >
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                      ...
                      <div
                        className="root-209cT gap6-U7x7I gridContainer-2-yiO style-akaH9"
                        id="style-akaH9"
                      >
                        <div className="root-2V0JZ root-1YE6q none-L5jAA">
                          <figure className="rootImage-ZV4q_ cornflower-1dhGY none-L5jAA">
                            <img
                              src="https://digitalasset.intuit.com/render/content/dam/intuit/mc-fe/en_us/images/cjb_paths_builder.jpg"
                              alt="[object Object]"
                              className="img-3SYic style-VOPBf"
                              id="style-VOPBf"
                            />
                          </figure>
                          <div className="content-2-FO1">
                            <div className="stack-1qp4V">
                              <p className="root-3TDqk medium-bold-2nZ0J eyebrow-EhSjj">
                                getting started
                              </p>
                              <a
                                target="_blank"
                                rel="noopener noreferrer"
                                href="https://mailchimp.com/help/about-customer-journeys/"
                                className="targetLink-omeiS"
                              >
                                About Customer Journeys
                              </a>
                              <p className="root-3TDqk medium-3AcAC">
                                Get started with our automation builder, and
                                create dynamic marketing paths for your
                                contacts.
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="content-2-FO1">
                            <div className="stack-1qp4V">
                              ...
                              <a
                                target="_blank"
                                rel="noopener noreferrer"
                                href="https://mailchimp.com/help/video/create-customer-journey/  "
                                className="targetLink-omeiS"
                              >
                                Quick start video
                              </a>
                              <p className="root-3TDqk medium-3AcAC">
                                Watch as we guide you through the process of
                                setting up an automation with the Customer
                                Journey builder.
                              </p>
                            </div>
                          </div>
                        ...
                        <div className="root-2V0JZ root-1YE6q none-L5jAA">
                          <figure className="rootImage-ZV4q_ none-L5jAA none-L5jAA">
                            <img
                              ...
                              alt="[object Object]"
                              className="img-3SYic style-UnPJo"
                              id="style-UnPJo"
                            />
                          </figure>
                          <div className="content-2-FO1">
                            <div className="stack-1qp4V">
                              ...
                              <a
                                target="_blank"
                                rel="noopener noreferrer"
                                href="https://mailchimp.com/help/create-customer-journey/"
                                className="targetLink-omeiS"
                              >
                                Create a Customer Journey
                              </a>
                              <p className="root-3TDqk medium-3AcAC">
                                Learn how to build automated workflows that
                                deliver personalized experiences for your
                                contacts.
                              </p>
                            </div>
                          </div>
                  ...
                  <div className="SocialProofContainer-1k58x">
                    <div className="standardContentArea-3GIm8">
                      <div className="switcher-2RqDX">
                        <div className="spacing6-21N1u">
                          <div className="stack-1qp4V spacing4-1xt6w socialProofContent-1pB0_">
                            <div>
                              <div className="socialProofLogo-2XA1M">
                                <img
                                  alt="Wonder logo"
                                  src="https://cdn-images.mailchimp.com/automations/prebuilt-journeys/wonder_logo.svg"
                                />
                              </div>
                              <p className="root-3TDqk medium-secondary-1YIN8">
                                From our customers
                              </p>
                              <blockquote>
                                <p className="root-3TDqk heading-2-SxWi_">
                                  One of the biggest victories for us is based
                                  on one of the journeys. We had attendance of
                                  our special events increase by 32%.
                                </p>
                              </blockquote>
                            </div>
                            <div>
                              <p className="root-3TDqk small-secondary-3_Rq2">
                                Michael Paul, Head of Customer Experience at
                                Wonder
                              </p>
                            </div>
                          </div>
                          <div>
                            <img
                              className="socialProofImage-1Ly-_"
                              alt="Michael Paul, Head of Customer Experience at Wonder"
