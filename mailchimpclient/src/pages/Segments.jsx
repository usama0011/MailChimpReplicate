        ...
        <div class="redesignNavigationExpandedRRClosed-1Pz4X snipcss0-2-5-6">
          ...
          <main id="content" class="body-1uBId snipcss0-3-6-246">
            <div class="frame-1q4n0 snipcss0-4-246-247">
              ...
              <div class="root-3uY95 snipcss-7GtD1">
                  ...
                  <header class="root-1rj4d standard-2H4cn header-3IL6q">
                    <div class="cluster-3D5Qr nowrap-34OZ-">
                      <div class="alignItemsCenter-1HCiJ justifyFlexStart-ejJl1 spacing4-1S_zR">
                        <div class="stack-1qp4V style-3jXPj" id="style-3jXPj">
                          <h1 class="heading-3-eDQNF root-PihPG">Segments</h1>
                        </div>
                      </div>
                    </div>
                    <div></div>
                ...
                <div class="container-6EX_l full-3zAe9">
                  <div class="root-1rj4d standard-2H4cn">
                    <div class="stack-1qp4V spacing8-10xOR">
                      ...
                      <div class="stack-1qp4V spacing7-3UvBh">
                        <div
                          class="root-209cT gap4-YRbD0 style-Yezc3"
                          id="style-Yezc3"
                        >
                          <div class="root-2V0JZ gridCard-1EYcc default-2CUpY">
                            <div class="clickArea-2gAoC clickArea-26kqU">
                              <div class="stack-1qp4V spacing6-nznRY cardContent-2alDG">
                                <div class="stack-1qp4V spacing4-1xt6w">
                                  <div class="iconContainer-2JDKz">
                                    <img
                                      alt=""
                                      src="https://cdn-images.mailchimp.com/product/surveys/freddieIcon.svg"
                                      class="icon-11HG6"
                                    />
                                  </div>
                                  ...
                                  <p class="root-3TDqk medium-secondary-1YIN8">
                                    Find contacts who signed up for your
                                    marketing in the last 7 days.
                                  </p>
                                </div>
                                <div>
                                  <button
                          ...
                          <div class="root-2V0JZ gridCard-1EYcc disabled-2d6SC default-2CUpY">
                            <div class="stack-1qp4V spacing4-1xt6w">
                              <div class="iconContainer-2JDKz disabled-XmhTZ">
                                <img
                                  alt=""
                                  src="https://cdn-images.mailchimp.com/product/surveys/freddieIcon.svg"
                                  class="icon-11HG6"
                              ...
                              <div class="toggletipContainer-zELVg">
                                <button class="root-1khsy" type="button">
                                  <span class="wink-visually-hidden">Help</span>
                                  <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24"
                                    focusable="false"
                              ...
                              <p class="root-3TDqk medium-secondary-1YIN8">
                                Find contacts who have opened any or all of your
                          ...
                          <div class="root-2V0JZ gridCard-1EYcc disabled-2d6SC default-2CUpY">
                            <div class="stack-1qp4V spacing4-1xt6w">
                              <div class="iconContainer-2JDKz disabled-XmhTZ">
                                <img
                                  src="https://cdn-images.mailchimp.com/automations/apps-integrations-logomarks/shopping-cart.svg"
                                  alt="Shopping Cart"
                                  class="icon-11HG6"
                                />
                              </div>
                              ...
                              <p class="root-3TDqk medium-secondary-1YIN8">
                                Find contacts who haven't placed an order in
                                your store.
                              </p>
                            </div>
                          </div>
                        ...
                        <div class="cluster-3D5Qr">
                          <div class="alignItemsCenter-1HCiJ justifyFlexStart-ejJl1 spacing2-3-fWQ">
                            <svg
                              ...
                              focusable="false"
                              aria-hidden="true"
                              class="wink-icon integrationIcon-3W__L"
                            >
                              <path
                                fill-rule="evenodd"
                                clip-rule="evenodd"
                            ...
                            <p class="root-3TDqk small-2qKd5">
                              ...
                              <a
                                class="root-sBgFt root-22EAH"
                                href="/campaigns/create?type=regular&amp;list_id=4955578&amp;__csrf_token=aa46f074f49a3e9b9a549efbb714e6da17e9ce06"
                              >
                                send an email
                              </a>
                            </p>
                    ...
                    <div class="cluster-3D5Qr">
                      <ul class="alignItemsCenter-1HCiJ justifyFlexStart-ejJl1 spacing6-zD2QG">
                        <li data-testid="horizontal-nav-item-overview">
                          ...
                          >
                            <p class="root-3TDqk medium-bold-2nZ0J">Overview</p>
                          </a>
                        </li>
                        <li data-testid="horizontal-nav-item-manage-contacts">
                          <div class="root-eTq9L">
                            <button
                              class="root-sBgFt container-3-bH7 secondary-1_P2K selected-1oN5L"
                              id="mc:197"
                              aria-expanded="false"
                              aria-haspopup="true"
                              type="button"
                            >
                              <span class="temporarySpan-2iF2p">
                                <p class="root-3TDqk medium-bold-2nZ0J selected-1oN5L">
                                  Manage contacts
                                </p>
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="root-1rj4d standard-2H4cn withBottomGutter-1OHF7 withTopGutter-PMsAu">
                  <div class="stack-1qp4V spacing5-3tdwQ">
                    <h2 class="heading-3-eDQNF root-PihPG">Saved by you</h2>
                    <div class="wrapper-2GUvc">
                      <div role="tablist" class="tabList-2ZCac">
                        <span
                          ...
                          tabindex="0"
                          aria-selected="true"
                          aria-controls="mc:206:tabs:0:panel"
                        >
                          Advanced Segments
                        </span>
                        <span
                          ...
                          tabindex="-1"
                          aria-selected="false"
                          aria-controls="mc:206:tabs:1:panel"
                        >
                          Regular Segments
                        </span>
                      </div>
                      <span
                        class="tabIndicator-2Ph-g style-4aHwP"
                        id="style-4aHwP"
                      ></span>
                    </div>
                    <div
                      ...
                      tabindex="-1"
                      role="tabpanel"
                      id="mc:206:tabs:0:panel"
                      aria-labelledby="mc:206:tabs:0"
                    >
                      <div class="stack-1qp4V spacing6-nznRY container-3LtsM">
                        <h3 class="heading-3-eDQNF root-PihPG">
                          Create segments to target contacts by location,
                          engagement, activity, and more.
                        </h3>
                        <div class="cluster-3D5Qr">
                          <div class="alignItemsCenter-1HCiJ justifyFlexStart-ejJl1 spacing4-1S_zR">
                            <button
                            ...
                            <a
                              ...
                              href="https://mailchimp.com/help/about-advanced-segmentation"
                              target="_blank"
                    ...
                    <div
                      ...
                      hidden=""
                      role="tabpanel"
                      id="mc:206:tabs:1:panel"
                      aria-labelledby="mc:206:tabs:1"
                    ></div>
                  </div>
                </div>
              </div>
