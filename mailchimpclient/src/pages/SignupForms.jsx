        ...
        <div class="redesignNavigationExpandedRRClosed-1Pz4X snipcss0-2-5-6">
          ...
          <main id="content" class="body-1uBId snipcss0-3-6-246">
            <div class="frame-1q4n0 snipcss0-4-246-247">
              ...
              <div class="root-3uY95 snipcss-zIEoK">
                  ...
                  <header class="root-1rj4d standard-2H4cn header-3IL6q">
                    <div class="cluster-3D5Qr nowrap-34OZ-">
                      <div class="alignItemsCenter-1HCiJ justifyFlexStart-ejJl1 spacing4-1S_zR">
                        <div class="stack-1qp4V style-TQVCe" id="style-TQVCe">
                    ...
                    <div class="stack-1qp4V spacing8-10xOR">
                      <div class="stack-1qp4V spacing2-3AKCb">
                        ...
                        <p class="root-3TDqk large-23Nnp">
                          ...
                          contacts.{" "}
                          <a href="/audience/segments/view-subscribers?id=4955578">
                            500
                          </a>{" "}
                      ...
                      <nav
                        class="horizontalNav-1eW7-"
                        aria-labelledby="audiencemenulabel"
                      >
                        <h2 id="audiencemenulabel" class="wink-visually-hidden">
                          Audiences menu
                        </h2>
                        <div class="cluster-3D5Qr">
                          <ul class="alignItemsCenter-1HCiJ justifyFlexStart-ejJl1 spacing6-zD2QG">
                            <li data-testid="horizontal-nav-item-overview">
                              <a
                                class="root-sBgFt root-22EAH"
                                href="/lists/dashboard/overview"
                              >
                            ...
                            <li data-testid="horizontal-nav-item-manage-contacts">
                            ...
                            <li data-testid="horizontal-nav-item-subscriber-preferences">
                              <a
                                class="root-sBgFt root-22EAH"
                            ...
                            <li data-testid="horizontal-nav-item-settings">
                              <div class="root-eTq9L">
                                <button
                                  class="root-sBgFt container-3-bH7 secondary-1_P2K"
                                  id="mc:109"
                            ...
                            <li>
                              <button
                                class="root-1khsy searchIcon-3E44t"
                      ...
                      <br />
                      <div
                        class="root-209cT gap6-U7x7I style-Ke9bl"
                        id="style-Ke9bl"
                      >
                        <div class="root-2V0JZ actionCard-23Utz default-2CUpY">
                          <div class="clickArea-2gAoC clickArea-2UwZV">
                            <figure class="rootImage-ZV4q_ cardImage-2CVn8 cucumber-L_n-M basic-RqZZf">
                              <img
                                src="https://digitalasset.intuit.com/render/content/dam/intuit/mc-fe/en_us/images/forms-landing-pages/forms-overview-aui-updates/form_builder_aui3x_compressed.png"
                                alt="Form builder"
                                class="img-3SYic style-LjNRB"
                                id="style-LjNRB"
                              />
                            </figure>
                            <div
                              class="stack-1qp4V spacing4-1xt6w style-6BaJx"
                              id="style-6BaJx"
                            >
                              <h3 class="heading-3-eDQNF root-PihPG">
                                Form builder
                              ...
                              <p class="root-3TDqk medium-secondary-1YIN8">
                                Manage fields and translations to keep your form
                                tailored to your audience.
                              </p>
                            </div>
                            <div id="style-OeAdo" class="style-OeAdo">
                              <a
                                class="root-sBgFt root-22EAH"
                                href="/lists/designer/?id=4955578"
                              >
                                Manage forms
                              </a>
                            </div>
                          ...
                          <div class="clickArea-2gAoC clickArea-2UwZV">
                            <figure class="rootImage-ZV4q_ cardImage-2CVn8 cucumber-L_n-M basic-RqZZf">
                              <img
                                ...
                                alt="Pop-up form"
                                class="img-3SYic style-xqBpi"
                                id="style-xqBpi"
                              />
                            </figure>
                            <div
                              class="stack-1qp4V spacing4-1xt6w style-qfKbH"
                              id="style-qfKbH"
                            >
                              <h3 class="heading-3-eDQNF root-PihPG">
                                Pop-up form&nbsp;
                                <span class="root-3ALOt new-1T1aO badgeNew-1U9Lu">
                                  <span class="wink-visually-hidden">(</span>New
                                  <span class="wink-visually-hidden">)</span>
                                </span>
                              </h3>
                              <p class="root-3TDqk medium-secondary-1YIN8">
                                Capture email and/or SMS contacts with a pop-up
                                form that can be added to any site.
                              </p>
                            </div>
                            <div id="style-R5MPD" class="style-R5MPD">
                              <a
                                class="root-sBgFt root-22EAH"
                                href="/signup-forms/popup-forms/editor?id=105052"
                              >
                                Create pop-up form
                              </a>
                            </div>
                          ...
                          <div class="clickArea-2gAoC clickArea-2UwZV">
                            <figure class="rootImage-ZV4q_ cardImage-2CVn8 cucumber-L_n-M basic-RqZZf">
                              <img
                                ...
                                alt="Embedded form"
                                class="img-3SYic style-19Too"
                                id="style-19Too"
                              />
                            </figure>
                            <div
                              class="stack-1qp4V spacing4-1xt6w style-yzRTr"
                              id="style-yzRTr"
                            >
                              <h3 class="heading-3-eDQNF root-PihPG">
                                Embedded form
                              ...
                              <p class="root-3TDqk medium-secondary-1YIN8">
                                Create a custom form that you can embed anywhere
                                on your website.
                              </p>
                            </div>
                            <div id="style-SVG3h" class="style-SVG3h">
                              <a
                                class="root-sBgFt root-22EAH"
                                href="/audience/forms/embedded-form/editor?id=4955578"
                              >
                        ...
                        <div class="root-2V0JZ actionCard-23Utz default-2CUpY">
                          <div class="clickArea-2gAoC clickArea-2UwZV">
                            <figure class="rootImage-ZV4q_ cardImage-2CVn8 cucumber-L_n-M basic-RqZZf">
                              <img
                                src="https://digitalasset.intuit.com/render/content/dam/intuit/mc-fe/en_us/images/forms-landing-pages/forms-overview-aui-updates/contact_form_builder3x_compressed.png"
                                alt="Contact form"
                                class="img-3SYic style-58bYh"
                                id="style-58bYh"
                              />
                            </figure>
                            <div
                              class="stack-1qp4V spacing4-1xt6w style-FmsRb"
                              id="style-FmsRb"
                            >
                              <h3 class="heading-3-eDQNF root-PihPG">
                                Contact form
                              ...
                              <p class="root-3TDqk medium-secondary-1YIN8">
                                Respond to customers directly from your{" "}
                                <a href="/audience/inbox/contact-form-editor?id=4955578&amp;source=audience_forms">
                                  Mailchimp Inbox
                                </a>
                                .
                              </p>
                            </div>
                            <div id="style-dVaPp" class="style-dVaPp">
                              <a
                                class="root-sBgFt root-22EAH"
                                href="/audience/inbox/contact-form-editor?id=4955578&amp;source=audience_forms"
                              >
                                Create contact form
                              </a>
                            </div>
                        ...
                        <div class="root-2V0JZ actionCard-23Utz default-2CUpY">
                          <div class="clickArea-2gAoC clickArea-2UwZV">
                            <figure class="rootImage-ZV4q_ cardImage-2CVn8 cucumber-L_n-M basic-RqZZf">
                              <img
                                src="https://digitalasset.intuit.com/render/content/dam/intuit/mc-fe/en_us/images/forms-landing-pages/forms-overview-aui-updates/form_integrations3x_compressed.png"
                                alt="Form integrations"
                                class="img-3SYic style-5yAok"
                                id="style-5yAok"
                              />
                            </figure>
                            <div
                              class="stack-1qp4V spacing4-1xt6w style-GdYIo"
                              id="style-GdYIo"
                            >
                              <h3 class="heading-3-eDQNF root-PihPG">
                                Form integrations
                              ...
                              <p class="root-3TDqk medium-secondary-1YIN8">
                                Connect your form to collect customer data and
                                increase revenue.
                              </p>
                            </div>
                            <div id="style-BFhil" class="style-BFhil">
                              <a
                                class="root-sBgFt root-22EAH"
                                href="/lists/integration/forms?id=4955578"
                              >
                                Integrations FAQ
                              </a>
                            </div>
                          ...
                          <div class="clickArea-2gAoC clickArea-2UwZV">
                            <figure class="rootImage-ZV4q_ cardImage-2CVn8 cucumber-L_n-M basic-RqZZf">
                              <img
                                ...
                                class="img-3SYic style-pfYQH"
                                id="style-pfYQH"
                              />
                            </figure>
                            <div
                              class="stack-1qp4V spacing4-1xt6w style-RkHOh"
                              id="style-RkHOh"
                            >
                              <h3 class="heading-3-eDQNF root-PihPG">
                                Signup landing page
                              ...
                              <p class="root-3TDqk medium-secondary-1YIN8">
                                Create a page to grow your audience that you can
                                share anywhere.
                              </p>
                            </div>
                            <div id="style-kyoxY" class="style-kyoxY">
                              <a
                                class="root-sBgFt root-22EAH"
                                href="/audience/forms/dashboard/#/create-campaign/explore/form:signupFormPage"
                              >
                                Create landing page
                              </a>
                            </div>
