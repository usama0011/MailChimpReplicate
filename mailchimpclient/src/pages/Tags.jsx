        ...
        <div class="redesignNavigationExpandedRRClosed-1Pz4X snipcss0-2-5-6">
          ...
          <main id="content" class="body-1uBId snipcss0-3-6-246">
            <div class="frame-1q4n0 snipcss0-4-246-247">
              ...
              <div class="root-3uY95 snipcss-JM1MU">
                  ...
                  <header class="root-1rj4d standard-2H4cn header-3IL6q">
                    <div class="cluster-3D5Qr nowrap-34OZ-">
                      <div class="alignItemsCenter-1HCiJ justifyFlexStart-ejJl1 spacing4-1S_zR">
                        <div class="stack-1qp4V style-pj5gi" id="style-pj5gi">
                          <h1 class="heading-3-eDQNF root-PihPG">Tags</h1>
                        </div>
                      </div>
                    </div>
                    <div></div>
                    <div class="actions-1bN9W cluster-3D5Qr">
                      <div class="alignItemsCenter-1HCiJ justifyFlexStart-ejJl1 spacing4-1S_zR">
                        <button
                          ...
                          type="button"
                        >
                          <span class="temporarySpan-2iF2p">Create Tag</span>
                        </button>
                        <a
                          class="root-sBgFt container-3-bH7 secondary-1_P2K"
                          href="/lists/tags/bulk-tag?id=4955578"
                        >
                        ...
                        <div class="actionBar-fkj6F cluster-3D5Qr">
                          <div class="alignItemsCenter-1HCiJ justifyFlexStart-ejJl1 spacing8-2cYQ4">
                            ...
                            <div class="cluster-3D5Qr">
                              <div class="alignItemsCenter-1HCiJ justifyFlexStart-ejJl1 spacing4-1S_zR">
                                <div class="root-TXRyV">
                                  <label id="mc:170" for="mc:169" class="">
                                    Sort by
                                  </label>
                                  <select id="mc:169">
                                ...
                                <button
                                  class="root-1khsy directionButton-3Nbt8"
                                  type="button"
                                >
                                  <span class="wink-visually-hidden">
                            ...
                            <button
                              ...
                              type="button"
                            >
                              <span class="temporarySpan-2iF2p">Delete</span>
                            </button>
                          </div>
                        </div>
                        <br />
                        <ul>
                          <li class="root-1Ur_2 interactive-3dK68">
                            <div class="wrapper-1hwHd">
                              ...
                              <div class="content-1QtDs">
                                <div>
                                  ...
                                  >
                                    <div class="alignItemsCenter-1HCiJ justifyFlexStart-ejJl1 spacing4-1S_zR">
                                      <div class="stack-1qp4V spacing2-3AKCb">
                                        <span class="root-1g3Ro large-1YXJ4">
                                          Auto
                                        </span>
                                      </div>
                                    </div>
                              ...
                              <div class="stats-2cqXV">
                                <dl>
                                  <dt>Created date</dt>
                                  <dd>Mar 17, 2024</dd>
                                </dl>
                              </div>
                              <div class="action-1_2Of">
                                <div class="root-2PJHr secondary-137Ik">
                                  <a
                                    class="root-sBgFt container-3-bH7 secondary-1_P2K button-1TVkv"
                                    href="/lists/segments/members/tags-filter?list_id=4955578&amp;tag_ids[]=10844874"
                                  >
                                    <span class="temporarySpan-2iF2p">
                                      View
                                    </span>
                                  ...
                                  <div class="root-eTq9L">
                                    <button
                                      class="root-sBgFt container-3-bH7 secondary-1_P2K actionList-3s02D"
                                      id="mc:176"
                                      aria-expanded="false"
                                      aria-haspopup="true"
                            ...
                            <div class="wrapper-1hwHd">
                              ...
                              <div class="action-1_2Of">
                                <div class="root-2PJHr secondary-137Ik">
                                  <a
                                    class="root-sBgFt container-3-bH7 secondary-1_P2K button-1TVkv"
                                    href="/lists/segments/members/tags-filter?list_id=4955578&amp;tag_ids[]=10844878"
                                  >
                                    <span class="temporarySpan-2iF2p">
                                      View
                                    </span>
                          ...
                          <div class="cluster-3D5Qr">
                            <div class="alignItemsCenter-1HCiJ justifyFlexStart-ejJl1 spacing4-1S_zR">
                              ...
                              <button
                                ...
                                type="button"
                              >
                                <span class="wink-visually-hidden">next</span>
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                                  viewBox="0 0 24 24"
                                  focusable="false"
                      ...
                      <div class="cluster-3D5Qr">
                        <div class="alignItemsCenter-1HCiJ justifyCenter-27O02 spacing4-1S_zR">
                          <div class="root-2V0JZ root-S6wl7 default-2CUpY">
                            <figure class="rootImage-ZV4q_ imgWrapper-3lumd yam-1zJu7 basic-RqZZf">
                              <img
                                src="https://cdn-images.mailchimp.com/product/brand_assets/illos/cards-illo/emphasize.png"
                                alt=""
                                class="img-3SYic style-OMdNU"
                                id="style-OMdNU"
                              />
                            </figure>
                            <div class="content-2aCYG">
                              <div class="stack-1qp4V">
                                <p class="root-3TDqk heading-3-2i9Gm">
                                  Automate Tagging
                                </p>
                                <p class="root-3TDqk medium-secondary-1YIN8 description-2Ors8">
                                  You can automate tagging your contacts with
                                  our API
                                </p>
                                <a
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  href="https://mailchimp.com/developer/marketing/guides/organize-contacts-with-tags/"
                                  class="targetLink-1cXS4"
                                >
