      ...
      <div id="root" aria-hidden="true" class="snipcss0-1-1-5">
        <div class="redesignNavigationExpandedRRClosed-1Pz4X snipcss0-2-5-6">
          ...
          <main id="content" class="body-1uBId snipcss0-3-6-246">
            <div className="root-3uY95 snipcss-QeOo3">
                ...
                <header className="root-1rj4d standard-2H4cn header-3IL6q">
                  <div className="cluster-3D5Qr nowrap-34OZ-">
                    <div className="alignItemsCenter-1HCiJ justifyFlexStart-ejJl1 spacing4-1S_zR">
                      <div className="stack-1qp4V style-dPB1n" id="style-dPB1n">
                        <nav
                          aria-labelledby="mc:102"
                          className="breadcrumbs-1_9F-"
                        >
                          <span id="mc:102" className="wink-visually-hidden">
                            Breadcrumbs
                          </span>
                          <ul>
                            <li>
                              <a
                                className="root-sBgFt breadcrumb-1MaXq"
                        ...
                        <h1 className="heading-4-3r-mu root-PihPG">
                          My Journeys
                        </h1>
                      </div>
                    </div>
              ...
              <div className="root-1rj4d standard-2H4cn withBottomGutter-1OHF7 withTopGutter-PMsAu">
                <div className="wrapper-2GUvc">
                  <div role="tablist" className="tabList-2ZCac">
                    <span
                      ...
                      tabindex="0"
                      aria-selected="true"
                      aria-controls="mc:103:tabs:0:panel"
                    >
                      Customer Journeys
                    </span>
                  </div>
                  <span
                    className="tabIndicator-2Ph-g style-wS7dJ"
                    id="style-wS7dJ"
                  ></span>
                </div>
                <div
                  ...
                  tabindex="-1"
                  role="tabpanel"
                  id="mc:103:tabs:0:panel"
                  aria-labelledby="mc:103:tabs:0"
                >
                  <div className="container-1O70M withSearch-2qXMN">
                    <div className="searchWrapper-35GfR">
                      <form
                        className="stack-1qp4V spacing6-nznRY"
                        novalidate=""
                        id="form-8t02c"
                      >
                        <div className="root-2RFjU searchInput--9ZnD">
                          <div className="before-2EDUs">
                            <label
                              className="mcds-label-default wink-visually-hidden"
                              id="mc:105"
                              for="mc:104"
                            >
                              Search by name
                          ...
                          <div className="inputWrapper-TVkf7">
                            ...
                            >
                              <svg
                                ...
                                focusable="false"
                                aria-hidden="true"
                                className="wink-icon searchIcon-2EmzU"
                              >
                                <path
                                  fill-rule="evenodd"
                                  clip-rule="evenodd"
                    ...
                    <div className="filterWrapper-2P2mO withSearch-2qXMN">
                      <div>
                        <div className="root-TXRyV">
                          <label id="mc:110" for="mc:109" className="">
                            Audience:
                          </label>
                          <div className="listbox-1KRYD">
                            <span
                              tabindex="0"
                              className="selectedValue-1AZV5"
                              id="mc:111-trigger"
                              aria-labelledby="Filter by audience mc:110"
                              role="combobox"
                            ...
                            >
                              Choose...
                              <span className="indicator-1Co1h">
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                                  viewBox="0 0 24 24"
                                  focusable="false"
                        ...
                        <div className="root-TXRyV">
                          <label id="mc:113" for="mc:112" className="">
                            Status:
                          </label>
                          <div className="listbox-1KRYD">
                            <span
                              ...
                              className="selectedValue-1AZV5"
                              id="mc:114-trigger"
                              aria-labelledby="Filter by status mc:113"
                              role="combobox"
                              aria-autocomplete="none"
                              aria-haspopup="listbox"
                              aria-expanded="false"
                        ...
                        <div className="root-TXRyV">
                          <label id="mc:116" for="mc:115" className="">
                            Objective:
                          </label>
                          <div className="listbox-1KRYD">
                            <span
                              ...
                              className="selectedValue-1AZV5"
                              id="mc:117-trigger"
                              aria-labelledby="Filter by intent mc:116"
                              role="combobox"
                              aria-autocomplete="none"
                              aria-haspopup="listbox"
                              aria-expanded="false"
                        ...
                        <button
                          className="root-sBgFt root-22EAH"
                          disabled=""
                          type="button"
                        >
                          Clear all
                      ...
                      <div>
                        <div className="root-TXRyV centerAlignOption-1KRp2 withSearch-2qXMN">
                          <label id="mc:119" for="mc:118" className="">
                            Sort by:
                          </label>
                          <div className="listbox-1KRYD">
                            <span
                              ...
                              className="selectedValue-1AZV5"
                              id="mc:120-trigger"
                              aria-labelledby="Sort by created_at mc:119"
                              role="combobox"
                              aria-autocomplete="none"
                              aria-haspopup="listbox"
                              aria-expanded="false"
                  ...
                  <div className="stack-1qp4V spacing6-nznRY emptyContent-QBkQN">
                    <img
                      className="emptyImage-3LJGM"
                      src="https://cdn-images.mailchimp.com/product/brand_assets/illos/ILLO_MiniSpot_EmailEngagement_800.png"
                      alt="email engagement"
                    />
                    <h3>You don’t have any Customer Journeys yet</h3>
                    <p className="root-3TDqk medium-3AcAC bodyText-1xftB">
                      Deliver great experiences with Customer Journeys.
                      Automated marketing helps you reach more customers with
                ...
                <div
                  ...
                  hidden=""
                  role="tabpanel"
                  id="mc:103:tabs:1:panel"
                  aria-labelledby="mc:103:tabs:1"
                ></div>
              </div>
            </div>
          </main>
