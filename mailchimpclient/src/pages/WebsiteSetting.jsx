...
import "../styles/WebsiteSetting.css";
        ...
        <div class="redesignNavigationExpandedRRClosed-1Pz4X snipcss0-2-5-6">
          ...
          <main id="content" class="body-1uBId snipcss0-3-6-246">
            <div class="frame-1q4n0 snipcss0-4-246-247">
              <main id="content" class="body-1uBId snipcss-MIdnr">
                <div class="wink">
                  <div class="root-3uY95">
                    ...
                    <div class="root-1rj4d standard-2H4cn withBottomGutter-1OHF7 withTopGutter-PMsAu">
                      <div
                        class="root-209cT gap4-YRbD0 style-gOaxP"
                        id="style-gOaxP"
                      >
                        <div class="imageWrapper-wismr">
                          <img
                            src="https://s3.amazonaws.com/cdn-images.mailchimp.com/website/settings/no-site.png"
                            alt=""
                            loading="lazy"
                            width="586"
                            height="586"
                        ...
                        <div class="stack-1qp4V spacing4-1xt6w content-kPuGe">
                          <h2 class="heading-2-ZDzRe root-PihPG">
                            After you set up your site, this is where you can
