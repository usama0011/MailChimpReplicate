...
// import "../styles/Integrationmanage.css";
        ...
        <div class="redesignNavigationExpandedRRClosed-1Pz4X snipcss0-2-5-6">
          ...
          <main id="content" class="body-1uBId snipcss0-3-6-246">
            <div class="frame-1q4n0 snipcss0-4-246-247">
              <div class="root-3uY95 snipcss-vtLZo">
                  ...
                  <header class="root-1rj4d standard-2H4cn header-3IL6q">
                    <div class="cluster-3D5Qr nowrap-34OZ-">
                      <div class="alignItemsCenter-1HCiJ justifyFlexStart-ejJl1 spacing4-1S_zR">
                        <div class="stack-1qp4V style-SvkaL" id="style-SvkaL">
                          <nav
                            aria-labelledby="mc:48"
                            class="breadcrumbs-1_9F-"
                          >
                            <span id="mc:48" class="wink-visually-hidden">
                              Breadcrumbs
                            </span>
                            <ul>
                              <li>
                          ...
                          <h1 class="heading-4-3r-mu root-PihPG">Manage</h1>
                        </div>
                      </div>
                    </div>
                    <div></div>
                ...
                <div class="root-1rj4d standard-2H4cn withBottomGutter-1OHF7 withTopGutter-PMsAu">
                  <div class="stack-1qp4V spacing8-10xOR">
                    <div class="stack-1qp4V spacing4-1xt6w">
                      <div
                        class="noConnectedAppsContainer-1PWEO style-XprWg"
                        id="style-XprWg"
                      >
                        <div class="stack-1qp4V spacing6-nznRY centeredContent-2ijmk">
                          <p class="root-3TDqk heading-2-SxWi_">
                            Connect the tools you use to run your business
                          </p>
                          <a
                            class="root-sBgFt container-3-bH7 primary-33czz browseButton-uKXjm"
                            href="/account/connected-sites/discover "
