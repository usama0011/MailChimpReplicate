...
import "../styles/MailChimpSurvy.css";
import { Link } from "react-router-dom";

const MailChimpSurvey = () => {
  return (
    <div
        ...
        <div class="redesignNavigationExpandedRRClosed-1Pz4X snipcss0-2-5-6">
          ...
          <main id="content" class="body-1uBId snipcss0-3-6-246">
            <div class="frame-1q4n0 snipcss0-4-246-247">
              ...
              <div class="root-3uY95 snipcss-wFYly">
                  ...
                  <header class="root-1rj4d standard-2H4cn header-3IL6q">
                    <div class="cluster-3D5Qr nowrap-34OZ-">
                      <div class="alignItemsCenter-1HCiJ justifyFlexStart-ejJl1 spacing4-1S_zR">
                        <div class="stack-1qp4V style-UjLA1" id="style-UjLA1">
                          <nav
                            aria-labelledby="mc:93"
                            class="breadcrumbs-1_9F-"
                          >
                            <span id="mc:93" class="wink-visually-hidden">
                              Breadcrumbs
                            </span>
                            <ul>
                              <li>
                          ...
                          <h1 class="heading-4-3r-mu root-PihPG">Surveys</h1>
                        </div>
                      </div>
                    </div>
                    <div></div>
                    <div class="actions-1bN9W cluster-3D5Qr">
                      <div class="alignItemsCenter-1HCiJ justifyFlexStart-ejJl1 spacing4-1S_zR">
                        <a
                          ...
                          href="/lists/surveys/create?list_id=4955578&amp;__csrf_token=8b77cb0de6030a49e2c42df30fc459570020e321"
                        >
                          <span class="temporarySpan-2iF2p">Create Survey</span>
                        </a>
                      </div>
                    </div>
                  </header>
                </div>
                <div class="root-3n_Fh cucumber-3Ivyg isBottomOverlap-K6Vv7">
                  <div class="root-1rj4d standard-2H4cn">
                    <div class="stack-1qp4V spacing4-1xt6w">
                      <h2 class="title-36k1q">Go from responses to results</h2>
                      <p class="secondary-35pfV">
                        Our surveys let you target, gather, and manage customer
                        feedback that can turn reviews and requests into
                        research-based products and services.{" "}
                      </p>
                      <div class="bottom-1WVe5">
                        <img
                          alt=""
                          src="https://digitalasset.intuit.com/render/content/dam/intuit/mc-fe/en_us/images/language-agnostic-assets/in-app-pages/audience/create-a-survey.png"
                          width="50%"
                        />
                      </div>
                    </div>
                ...
                <div class="root-1rj4d standard-2H4cn withBottomGutter-1OHF7 withTopGutter-PMsAu">
                  <div class="stack-1qp4V spacing9-XZMyI">
                    <div class="root-1cS4q audienceSelect-2LyEk">
                    ...
                    <h2 class="audienceInfo-1_NKj">
                      Your audience has{" "}
                      <a href="/lists/members/clear-and-view?id=4955578">500</a>{" "}
                      contacts.{" "}
                      <button
                        class="root-sBgFt container-3-bH7 tertiary-Wmhgk tertiaryButton-1MRu_"
                        type="button"
                      >
                        <span class="temporarySpan-2iF2p">500</span>
                      </button>{" "}
                      of these are subscribed.
                    </h2>
                    <div class="wrapper-3aTBe">
                      <hr />
                      <div class="cluster-3D5Qr">
                        <div class="alignItemsCenter-1HCiJ justifyCenter-27O02 spacing4-1S_zR">
                          <div class="stack-1qp4V spacing7-3UvBh contents-3tHn2">
                            <h2 class="center-1JgYM">
                              Get business insights when you collect feedback
                              from your audience
                            </h2>
                            <div class="center-1JgYM">
                              <a
                                class="root-sBgFt container-3-bH7 primary-33czz"
                                href="/lists/surveys/create?list_id=4955578&amp;__csrf_token=8b77cb0de6030a49e2c42df30fc459570020e321"
                              >
                            ...
                            <a
                              class="center-1JgYM"
                              href="https://mailchimp.com/help/create-a-survey/?_ga=2.142309106.1153585578.1628517637-522120772.1624578948"
                              target="_blank"
                              rel="noopener noreferrer"
                            >
                              Learn more about Mailchimp Surveys
                            </a>
                          </div>
                        </div>
                      </div>
                    ...
                    <div>
                      <div class="header-S-Iib">
                        <h2 class="heading-3-eDQNF root-PihPG">
                          Start with a template
                        </h2>
                      </div>
                      <ul class="cardListContainer-3hDcA">
                        <li class="card-2OuoJ">
                          <div class="stack-1qp4V spacing4-1xt6w">
                            <div class="cardDetails-3OA17">
                              <div class="clickArea-2gAoC">
                                <div>
                                  <span class="root-3ALOt active-KJsYo categoryBadge-3AUoO">
                                ...
                                <a href="#">
                                  <p class="root-3TDqk heading-3-2i9Gm contentTitle-weCFy">
                                    Post-purchase (1-10 scale) Survey
                                  </p>
                                </a>
                                <p class="root-3TDqk small-2qKd5 contentDescription-cyWyK">
                                  Post-purchase satisfaction survey on 1-10
                                  scale. Includes an intro and 2 questions.{" "}
                                </p>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="stack-1qp4V spacing4-1xt6w">
                            <div class="cardDetails-3OA17">
                              <div class="clickArea-2gAoC">
                                ...
                                <a href="#">
                                  <p class="root-3TDqk heading-3-2i9Gm contentTitle-weCFy">
                                    Post-purchase Emojis Survey
                                  </p>
                                </a>
                                <p class="root-3TDqk small-2qKd5 contentDescription-cyWyK">
                                  Post-purchase satisfaction survey using
                                  emojis. Includes an intro and 2 questions.
                                </p>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="stack-1qp4V spacing4-1xt6w">
                            <div class="cardDetails-3OA17">
                              <div class="clickArea-2gAoC">
                                ...
                                <a href="#">
                                  <p class="root-3TDqk heading-3-2i9Gm contentTitle-weCFy">
                                    Post-event (1-10 scale) Survey
                                  </p>
                                </a>
                                <p class="root-3TDqk small-2qKd5 contentDescription-cyWyK">
                                  Post-event satisfaction survey on 1-10 scale.
                                  Includes an intro and 2 questions.
                                </p>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="stack-1qp4V spacing4-1xt6w">
                            <div class="cardDetails-3OA17">
                              <div class="clickArea-2gAoC">
                                ...
                                <a href="#">
                                  <p class="root-3TDqk heading-3-2i9Gm contentTitle-weCFy">
                                    Post-event Emojis Survey
                                  </p>
                                </a>
                                <p class="root-3TDqk small-2qKd5 contentDescription-cyWyK">
                                  Post-event satisfaction survey using emojis.
                                  Includes an intro and 2 questions.
                                </p>
                              </div>
                            </div>
                          ...
                          <div class="stack-1qp4V spacing4-1xt6w">
                            <div class="cardDetails-3OA17">
                              <div class="clickArea-2gAoC">
                                ...
                                <p class="root-3TDqk small-2qKd5 contentDescription-cyWyK">
                                  A simple one question survey to assess which
                                  marketing channels are most effective for you.
                                </p>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="stack-1qp4V spacing4-1xt6w">
                            <div class="cardDetails-3OA17">
                              <div class="clickArea-2gAoC">
                                ...
                                <p class="root-3TDqk small-2qKd5 contentDescription-cyWyK">
                                  A five question survey to engage customers and
                                  identify new products/services to foster
                                  growth.
                                </p>
                              </div>
                            </div>
                  ...
                  <div class="footer-pzhkW">
                    ...
                    <div class="switcher-2RqDX">
                      <div class="spacing3-2zPjs">
                        <div class="root-2V0JZ root-1YE6q none-L5jAA">
                          <figure class="rootImage-ZV4q_ cornflower-1dhGY medium-3K4Vo">
                            <img
                              src="https://cdn-images.mailchimp.com/product/surveys/how-to-create-survey.png"
                              alt="How to create a Survey"
                              class="img-3SYic style-6y9so"
                              id="style-6y9so"
                            />
                          </figure>
                          <div class="content-2-FO1">
                            <div class="stack-1qp4V">
                              <p class="root-3TDqk medium-bold-2nZ0J eyebrow-EhSjj">
                                Guide
                              </p>
                              <a
                                target="_blank"
                                rel="noopener noreferrer"
                                href=" https://mailchimp.com/help/create-a-survey/?_ga=2.150789494.1310757255.1654009078-1235817555.1652110119"
                                class="targetLink-omeiS"
                              >
                                How to create a Survey
                              </a>
                              <p class="root-3TDqk medium-3AcAC">
                                {" "}
                                Follow this guide to create a survey and collect
