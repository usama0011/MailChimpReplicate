      ...
      <div id="root" aria-hidden="true" class="snipcss0-1-1-5">
        <div class="redesignNavigationExpandedRRClosed-1Pz4X snipcss0-2-5-6">
          ...
          <main id="content" class="body-1uBId snipcss0-3-6-246">
            <div className="root-3uY95 snipcss-gk2Nr">
                ...
                <header className="root-1rj4d standard-2H4cn header-3IL6q">
                  <div className="cluster-3D5Qr nowrap-34OZ-">
                    <div className="alignItemsCenter-1HCiJ justifyFlexStart-ejJl1 spacing4-1S_zR">
                      <div className="stack-1qp4V style-M4qqq" id="style-M4qqq">
              ...
              <div className="root-1rj4d standard-2H4cn withBottomGutter-1OHF7 withTopGutter-PMsAu">
                <div className="actions-3MQ_B cluster-3D5Qr">
                  <div className="alignItemsCenter-1HCiJ justifyFlexEnd-3_ERd spacing4-1S_zR">
                    <a
                      className="root-sBgFt container-3-bH7 tertiary-Wmhgk"
                      href="/reports/#t:comparative-list"
                    >
                    ...
                    <a
                      ...
                      href="/analytics/custom-reports/builder"
                    >
                      <span className="temporarySpan-2iF2p">
                ...
                <div className="stack-1qp4V spacing4-1xt6w">
                  <div className="stack-1qp4V tableContainer-2FjOx">
                    <table className="root-2_tvf table-WIzs7">
                      <caption className="wink-visually-hidden">
                        undefined table
                      </caption>
                      <thead>
                        <tr>
                          <th className="">
                            <button
                              className="root-sBgFt root-22EAH sortButton-3pIP0"
                              aria-sort="none"
                              arial-label="Sort by Report"
                              type="button"
                            >
                              <div className="cluster-3D5Qr">
                                <div className="alignItemsCenter-1HCiJ justifyFlexStart-ejJl1 spacing1-3SkHe">
                                  ...
                                  <div className="sortIconContainer-34MAx">
                                    <svg
                                      xmlns="http://www.w3.org/2000/svg"
                                      viewBox="0 0 16 16"
                                      focusable="false"
                                      aria-hidden="true"
                                      className="wink-icon iconNoSorting-fqNfd"
                          ...
                          <th className="">
                            <button
                              className="root-sBgFt root-22EAH sortButton-3pIP0"
                              aria-sort="none"
                              arial-label="Sort by Date created"
                              type="button"
                            >
                              <div className="cluster-3D5Qr">
                                <div className="alignItemsCenter-1HCiJ justifyFlexStart-ejJl1 spacing1-3SkHe">
                          ...
                          <th className="alignLeft-240hy"></th>
                          <th className="alignLeft-240hy"></th>
                          <th className="alignLeft-240hy"></th>
                        </tr>
                      </thead>
                ...
                <div className="empty-3u_mE">
                  <div className="cluster-3D5Qr nowrap-34OZ-">
                    <div className="alignItemsFlexStart-3pYa_ justifyFlexStart-ejJl1 spacing4-1S_zR">
                      <div className="stack-1qp4V spacing2-3AKCb">
                        <p className="root-3TDqk heading-3-2i9Gm emptyTitle-RETPF">
                          Get in-depth analysis of your email performance
                        </p>
                        <p className="root-3TDqk medium-3AcAC emptyDescription-2X3rK">
                          Dive deeper into the metrics that matter most to you.
                          See the metrics you specify and chart your performance
                          over time.
                        </p>
                        <div>
                          <a
                            className="root-sBgFt root-22EAH"
                            href="https://mailchimp.com/help/create-custom-reports/"
                          >
                            Learn more
                          </a>
                        </div>
                      ...
                      <img
                        className="emptyImage-2mdh7"
                        src="https://cdn-images.mailchimp.com/product/reports/customReports/no-reports.png"
                        alt="Empty state"
                      />
                    </div>
                  </div>
